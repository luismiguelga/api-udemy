...
class Response
{
    ...
    public static function make(
        string $message = 'Solicitud exitosa',
        ?string $error = null,
        ResourceCollection|JsonResource|array|null $errors = null,
        ResourceCollection|JsonResource|array|null $data = null,
        int $code = 200,
        array $headers = []
    ): JsonResponse {
        $response = [
            'status' => self::getCodeMessage($code),
            'message' => $message,
        ];
    ...
    private static function getCodeMessage(int $code): string
    {
        $messages = [
            200 => 'OK',
            201 => 'Created',
